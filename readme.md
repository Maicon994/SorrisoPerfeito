# Projeto: Landing Page para Consultório Dentário - Sorriso Perfeito
...
- [x] **[Desafio Extra]** Menu Hambúrguer interativo para dispositivos móveis.
- [x] **[Desafio Extra]** Animações de Scroll (`fade-in` e subida suave nas seções).
